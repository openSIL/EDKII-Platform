...
/**
  ...
  @param  This    Pointer to HII_NUMBER instances.
...
/**
  ...
  @param  This    Pointer to HII_NUMBER instance.
...
/**
  ...
  @return EFI_SUCCESS           Buffer allocated.
...
/**
  ...
  @param  This    Pointer to HII_NUMBER instance.
  @param  String  String to get value from. String may end in \0 or &.
...
/**
  ...
  @param  This    Pointer to HII_STRING instance.
  @param  Size    Size of intitial allocation.

  @return EFI_SUCCESS           Allocated buffer successfully.
  @return EFI_OUT_OF_RESOURCES  Out of memory.
**/
EFI_STATUS
HiiStringInit (
...
/**
  ...
  @return EFI_SUCCESS           String is appended.
  @return EFI_OUT_OF_RESOURCES  OUt of memory.
...
/**
  ...
  @param  Hdr           Element Header to sarch for.
  @param  String        Search for element header in this string.

  @return Pointer to value in element header.
  @return NULL if element header not found or end of string.
...
/**
  ...
  @return Pointer after value in element header.
...
/**
  ...
  @return Pointer after ConfigHdr.
  @return NULL if Config header not formed correctly.
